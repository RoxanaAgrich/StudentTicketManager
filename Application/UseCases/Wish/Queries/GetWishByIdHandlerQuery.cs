...
{
    public class GetWishByIdHandlerQuery : IRequestHandler<GetWishByIdQuery, Result<WishResponse>>
    {
        private readonly IRepositoryBase<Domain.Entities.Wish, Guid> _wishRepository;
        private readonly IMapper _mapper;

        public GetWishByIdHandlerQuery(IRepositoryBase<Domain.Entities.Wish, Guid> wishRepository, IMapper mapper)
        {
